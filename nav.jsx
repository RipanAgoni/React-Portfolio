...
const nav = () => {
  return (
    <div className=" ">
      <header className=" top-0 z-10 pointer-events-none flex items-center justify-between w-full px-4 mt-4 max-w-screen-xl mx-auto ">
        ...
        <div className="flex gap-4 pointer-events-auto">
          <svg
            ...
            class="feather feather-sun cursor-pointer z-10"
