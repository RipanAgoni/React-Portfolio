...
import contactMeImage from '../../assets/image/contact-me.svg'; // Make sure the path is correct
    ...
    <section className="max-w-screen-xl mx-auto px-4 pb-12">
      ...
      <div className="flex flex-col md:flex-row items-center mt-10">
        <div className="w-full">
          <img src={contactMeImage} alt="phone" />
        </div>
<form className="w-full" name="contactUS" netlify>
          ...
          <div className="relative mb-4">
            ...
            <textarea id="message" name="message" rows="8" placeholder="Your message here"
