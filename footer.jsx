...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center pb-10">
      <p className="text-xs text-gray-300">Master Zed © 2025</p>
      <div className="black-logo my-4">
        {/* The SVG code remains the same as it's a direct SVG embed */}
        <svg width="50" height="50" viewBox="0 0 406 368" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            stroke="#1F2667" strokeOpacity="0.9" strokeWidth="16"></path>
          <path
            d="M314.899 203.5L314.899 349.43L162.5 209.053M314.899 203.5L283.037 203.586M314.899 203.5L337.881 203.586L381 171.109L314.899 171.109M162.5 209.053L118.044 170.96L157.5 171.109M162.5 209.053L65.5 301.465L20.5595 301.465L137.482 189.156M200.5 171.109L283.037 96.5L283.037 171.109M200.5 171.109L283.037 171.109M200.5 171.109L157.5 171.109M283.037 203.586L210.846 203.123L283.037 271.086L283.037 203.586ZM283.037 171.109L314.899 171.109M157.5 171.109L316.135 20.4322L314.899 171.109"
            stroke="url(#paint0_linear)" strokeWidth="16"></path>
          <defs>
      ...
      <ul className="mx-auto flex items-center justify-center gap-6 text-[#b0b2c3]">
        ...
        <li>
          <a href="https://www.instagram.com/procodrr/" target="_blank" rel="noopener noreferrer">
            <svg className="w-5 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path fill="currentColor"
        ...
        <li>
          <a href="https://www.youtube.com/@procodrr" target="_blank" rel="noopener noreferrer">
            <svg className="w-5 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
              fill="currentColor">
              <path
